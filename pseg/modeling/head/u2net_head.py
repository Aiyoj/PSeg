...
class U2NetHead(nn.Module):
    def __init__(self, config=None):
        ...
        self.side1 = nn.Conv2d(cfg[4][2], out_ch, 3, padding=1)
        self.side2 = nn.Conv2d(cfg[3][2], out_ch, 3, padding=1)
        self.side3 = nn.Conv2d(cfg[2][2], out_ch, 3, padding=1)
        self.side4 = nn.Conv2d(cfg[1][2], out_ch, 3, padding=1)
        self.side5 = nn.Conv2d(cfg[0][2], out_ch, 3, padding=1)
        self.side6 = nn.Conv2d(cfg[0][2], out_ch, 3, padding=1)
