...
class IaaAugment(object):
    ...
    def __call__(self, data):
        ...
        if self.augmenter:
            ...
            data["label"] = aug.augment_image(mask)
    ...
    #         return data
    #
    #     if "exterior" in data.keys():
    #         line_polys = []
    #         for poly in data["exterior"]:
    #             new_poly = self.may_augment_poly(aug, shape, poly)
    #             line_polys.append(new_poly)
    #         data["exterior"] = np.array(line_polys)
    #
    #     if "interior" in data.keys():
    #         line_polys = []
    #         for poly in data["interior"]:
    #             new_poly = self.may_augment_poly(aug, shape, poly)
    #             line_polys.append(new_poly)
    #         data["interior"] = np.array(line_polys)
    #
    #     return data
